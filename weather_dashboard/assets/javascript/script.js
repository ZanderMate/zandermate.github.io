...
$(".search").click(function () {
    ...
    var newLi = $("<li>");
    newLi.text(cityName);
    newLi.addClass("btn btn-dark-outline line-item list-group-item").attr('id', "city-name-" + cityList.length);
...
function getWeather(myCity) {
    var queryUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + myCity + "&apikey=" + apiKey;
    $.ajax({
        url: queryUrl,
        method: "GET"
        ...
        var forecastURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + myCity + "&apikey=" + apiKey;
